    ...
    return (
        ...
        >
            ...
            >
                ...
                <Typography variant='subtitle1' fontFamily={'Source Sans Regular'} fontSize={'1.25rem'} marginTop={2}>
                    At Sewmii Pattern Studio, we offer premium quality printed patterns for sewing enthusiasts, aspiring designers, and garment businesses.
                    Our patterns are designed to facilitate those who wish to embark on sewing as a hobby but lack pattern-making skills,
                    as well as those looking to create bespoke garments at home or for commercial purposes.
                </Typography>
            </Box>
            ...
            >
                ...
                <Typography variant='subtitle1' fontFamily={'Source Sans Regular'} fontSize={'1.25rem'} mb={2}>
            ...
            >
                ...
                <Typography variant='subtitle1' fontFamily={'Source Sans Regular'} fontSize={'1.25rem'} marginTop={2} marginBottom={2}>
                ...
                >
                    <Button3D href="/services#contact-cards-container" newTab={false}>Enquire Now</Button3D>
